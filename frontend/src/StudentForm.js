...
function StudentForm()
{
    ...
    return( 
        ...
        <div className="flex flex-col bg-blue-100 w-full h-screen">
            ...
            {/* Pending Forms */}
            <div className="bg-blue-800 ml-5 mt-5 mr-5 rounded-xl p-4">
                ...
                {forms.filter((forms)=>forms.status === "pending").map((form, index) => (
                    <form key={index} className="mb-2 bg-blue-600 mb-5 p-5 rounded-lg flex-col flex">
                        ...
                        <input className="rounded bg-blue-300 text-blue-800 w-max" type="file"/>
